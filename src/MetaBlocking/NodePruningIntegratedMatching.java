 ...
 * @author gap2
 */
public class NodePruningIntegratedMatching extends NodePruning {

    private final EntityProfile[] profiles1;
    private final EntityProfile[] profiles2;

    public NodePruningIntegratedMatching(List<EntityProfile> pr1, List<EntityProfile> pr2, WeightingScheme scheme) {
