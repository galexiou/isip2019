...
public class ProfileComparison {
	...
	public static double getJaroSimilarity(Set<Attribute> profile1, Set<Attribute> profile2) {
		String string1 = "";
		String string2 = "";
		HashMap<String, String> at1 = new HashMap<>();
		HashMap<String, String> at2 = new HashMap<>();
		for (Attribute attribute1 : profile1) {
			if (attribute1.getValue() == null)
				continue;
			at1.put(attribute1.getName(), attribute1.getValue());
		}

		for (Attribute attribute2 : profile2) {
			if (attribute2.getValue() == null)
				continue;
			at2.put(attribute2.getName(), attribute2.getValue());
		}

		int total = 0;
		double mean = 0;
		double acc = 0;
		for (String key : at1.keySet()) {
