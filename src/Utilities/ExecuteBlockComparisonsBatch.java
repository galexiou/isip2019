 ...
 * @author gap2
 */
public class ExecuteBlockComparisonsBatch {
 
    private final EntityProfile[] dataset1;
    private final EntityProfile[] dataset2;
    
    public ExecuteBlockComparisonsBatch(String[] profilesPath) {
    ...
    public ExecuteBlockComparisonsBatch(List<EntityProfile>[] profiles) {
        ...
        for (AbstractBlock block : blocks) {
            ...
            while (iterator.hasNext()) {
                ...
                if (dataset2 != null) {
                    ...
                    ProfileComparison.getJaccardSimilarity(dataset1[comparison.getEntityId1()-1].getAttributes(), 
                                                           dataset1[comparison.getEntityId2()-1].getAttributes());
                }
            }
        }
