...
public class UnilateralIterativeBlockingWithInstanceMatching {
    ...
    public UnilateralIterativeBlockingWithInstanceMatching(List<AbstractBlock> initialBlocks, 
        ...
        prepareDataStructures(initialBlocks, profiles);
    }
    ...
    private int getDetectedDuplicates() {
        ...
        for (int i = 0; i < entityIndex.getNoOfEntities(); i++) {
            int[] equCluster = Converter.convertListToArray(maxRecords[i]);
    ...
    private void prepareDataStructures(List<AbstractBlock> initialBlocks, List<EntityProfile> profiles) {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        for (int j = 5; j < datasets.length; j++) {
            ...
            for (int i = 0; i < 10; i++) {
            ExportBlocks exportBlocks = new ExportBlocks(indexDir, null);
            ...
            List<EntityProfile> entityProfiles = (ArrayList<EntityProfile>) SerializationUtilities.loadSerializedObject(entitiesPath);
            
            UnilateralIterativeBlockingWithInstanceMatching uniItBlocking = new UnilateralIterativeBlockingWithInstanceMatching(blocks, entityProfiles, duplicates);
